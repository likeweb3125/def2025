...
export const translations = {
  ko: {
    ...
    pastEvents: {
      ...
      def2018ForumDesc: `<p>DEF의 첫 발을 내딛은 DEF2018은,</br></br>
      정부와 민간이 협력하여, 혁신성장을 위한 디지털경제의 원동력을 조망하는 자리로 특히 혁신의 원동력인 플랫폼경제와 창업가정신을 집중적으로 조명하였습니다.</br></br>DEF 2018은 ‘플랫폼레볼루션’의 저자 제프리 파커와 대한민국 대표 플랫폼 ‘네이버’의 한성숙 대표, 그리고 프랑스 IT혁신 학교 ‘에꼴42’의 소피 비제르 디렉터의 기조연설을 시작으로 플랫폼 비즈니스 전망과 혁신 성장 사례를 공유하는 세션으로 구성되었습니다.</p>`,
