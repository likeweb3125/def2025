  ...
  ko: {
    ...
    program: {
      ...
      table2: {
        ...
        fourthTitle:
          "<div><strong class='text-[20px] font-bold text-[#333333] max-[500px]:text-[18px]'>기조연설 1 : AI와 미래의 설계</strong><p class='mt-2 text-[18px] text-[#666666]'></p></div>",
        fourthContents:
        ...
        sixthTitle:
          "<div><strong class='text-[20px] font-bold text-[#333333] max-[500px]:text-[18px]'>기조연설 2-2 : 인공지능과 우리 삶(2)</strong><p class='mt-2 text-[18px] text-[#666666]'></p></div>",
        sixthContents:
        ...
        eighthTitle:
          "<div><strong class='text-[20px] font-bold text-[#333333] max-[500px]:text-[18px]'>패널토의 세션 1 : AI와 산업의 미래</strong><p class='mt-2 text-[18px] text-[#666666]'></p></div>",
        eighthContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'><div><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>좌장</span><strong class='mx-3 max-[500px]:ml-0'>송경호</strong> 인공지능안전연구소 선임연구원</div><div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] whitespace-nowrap'>발제</span><div><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Jerrard Sheehan</strong>OECD Director of Science, Technology and Innovation directorate</div><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Mingxin Zheng</strong>NVIDIA Sr. Software Engineer</div></div></div><div class='!mb-0'><span class='text-[#055DA5] whitespace-nowrap font-semibold max-[500px]:block max-[500px]:text-[14px]'>패널</span><strong class='mx-3 max-[500px]:ml-0'>이현진</strong>대외경제정책연구원 부연구위원</div><div> <span class='text-[#055DA5] whitespace-nowrap font-semibold max-[500px]:block max-[500px]:text-[14px] opacity-0 max-[500px]:hidden'>패널</span><strong class='mx-3 max-[500px]:ml-0'>김용기</strong>과학기술정책연구원 부연구위원 </div></div>",
        eighthLabel:
        ...
        ninthTitle:
          "<div><strong class='text-[20px] font-bold text-[#333333] max-[500px]:text-[18px]'>패널토의 세션 2 : AI 스타트업 해외진출 및 협력사례</strong><p class='mt-2 text-[18px] text-[#666666]'></p></div>",
        ninthContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'><div><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>좌장</span><strong class='mx-3 max-[500px]:ml-0'>구진경</strong>산업연구원 실장&middot;선임연구위원</div><div class='!mb-0'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>발제</span><strong class='mx-3 max-[500px]:ml-0'>신승용</strong>(주)엔에스데블 이사&middot;위원장</div><div><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] opacity-0 max-[500px]:hidden'>발제</span><strong class='mx-3 max-[500px]:ml-0'>이우영</strong>씨이랩 의장</div><div class='!mb-0'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>패널</span><strong class='mx-3 max-[500px]:ml-0'>윤여경</strong>창업진흥원 실장</div><div><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] opacity-0 max-[500px]:hidden'>패널</span><strong class='mx-3 max-[500px]:ml-0'>정병윤</strong>IBK투자증권 디지털혁신본부 본부장&middot;상무</div></div>",
        ninthLabel:
...
`,
    ...
    program: {
      ...
      table2: {
        ...
        secondContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'><div class='flex max-[500px]:flex-col'> <span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] whitespace-nowrap'>Opening Remark</span><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Lee Hyoung-Il</strong> 1st Vice Minister, Ministry of Economy and Finance</div></div><div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] whitespace-nowrap'>Welcoming Remark</span><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Kim Chun-Kon</strong> Vice President of Research, Korea Institute for Industrial Economics and Trade</div></div></div>",
        secondLabel: "",
        thirdTitle:
        ...
        fourthContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'> <div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>Moderator</span><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Shin Kwan-Ho</strong> Professor, Korea University</div></div><div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] whitespace-nowrap'>Keynote Speaker</span><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Anton Korinek</strong> Professor, University of Virginia (Online Presentation)</div></div></div>",
        fourthLabel:
          "<p class='text-[14px] font-bold text-[#333333] bg-[#F5C7FF] px-4 py-2 max-[500px]:text-[12px] max-[500px]:px-2 max-[500px]:py-[6px]'>KEYNOTE SPEECH 1</p>",
        fifthTitle:
          "<p class='text-[20px] font-bold text-[#333333] max-[500px]:text-[18px]'>Keynote Speech 2 :<br/>AI and Our Daily Lives(1)</p>",
        fifthContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'><div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] whitespace-nowrap'>Keynote Speaker</span><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Sung Nak-Ho</strong> EVP, NAVER Cloud</div></div></div>",
        fifthLabel:
          "<p class='text-[14px] font-bold text-[#333333] bg-[#F5C7FF] px-4 py-2 max-[500px]:text-[12px] max-[500px]:px-2 max-[500px]:py-[6px]'>KEYNOTE SPEECH 2-1</p>",
        sixthTitle:
          "<p class='text-[20px] font-bold text-[#333333] max-[500px]:text-[18px]'>Keynote Speech 2-2 :<br/>AI and Our Daily Lives(2)</p>",
        sixthContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'><div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px] whitespace-nowrap'>Keynote Speaker</span><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Yoo Yong-Ha</strong> Performance Leader, Kakao Corp.</div></div></div>",
        sixthLabel:
          "<p class='text-[14px] font-bold text-[#333333] bg-[#F5C7FF] px-4 py-2 max-[500px]:text-[12px] max-[500px]:px-2 max-[500px]:py-[6px]'>KEYNOTE SPEECH 2-2</p>",
        seventhTitle:
        ...
        eighthContents:
          "<div class='bg-[#F4F7F9] px-6 py-[22px] space-y-3 text-[#666666] max-[500px]:p-4 rounded-[8px]'> <div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>Moderator</span><div class='flex flex-col mx-3 max-[500px]:ml-0'> <strong>Song Kyung-Ho</strong> Senior Researcher, Korea AI Safety Institute</div></div> <div class='flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>Speaker</span><div><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Jerrard Sheehan</strong> Director, Science,Technology and Innovation directorate, OECD</div><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Mingxin Zheng</strong> Sr. Software Engineer, NVIDIA</div></div></div><div class='!mb-0 flex max-[500px]:flex-col'><span class='text-[#055DA5] font-semibold max-[500px]:block max-[500px]:text-[14px]'>Panelist</span> <div><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Lee Hyun-Jin</strong> Associate Research Fellow, Korea Institute for International Economic Policy</div><div class='flex flex-col mx-3 max-[500px]:ml-0'><strong>Kim Yong-Gi</strong>Associate Research Fellow, Science and Technology Policy Institute </div></div><div></div>",
        ninthTitle:
    ...
    speakers: {
      ...
      panelists1: {
        ...
        mingxinZheng: {
          ...
          position: `NVIDIA \nSr. Software Engineer`,
          session: "Panel Discussion Session 1",
          sessionDesc: "Speaker (Online Presentation)",
        },
        leeHyunJin: {
          name: "Lee Hyun-Jin",
      ...
      panelists2: {
        ...
        yoonyeokyung: {
          name: "Yoon Yeo-Kyung",
          position: `Korea Institute of Startup & Entrepreneurship Development\n Director`,
          session: "Panel Discussion Session 2",
          sessionDesc: "Panelist",
        },
        jeongbyeongyoon: {
          name: "Jung Byung-Yoon",
          position: `IBK Securities &middot; Digital Innovation Division\n Managing Director`,
          session: "Panel Discussion Session 2",
          sessionDesc: "Panelist",
        },
      },
